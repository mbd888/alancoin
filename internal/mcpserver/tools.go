...
var ToolCallService = mcp.NewTool("call_service",
	...
	mcp.WithString("prefer",
		mcp.Description("Service selection strategy: 'cheapest', 'reputation' (best rated), 'best_value', or 'budget' (adapts quality/cost tradeoff to remaining budget)"),
		mcp.Enum("cheapest", "reputation", "best_value", "budget")),
